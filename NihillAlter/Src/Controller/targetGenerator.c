...
void sideWallControl( void )
{
  ...
  if ( sidewall_control_flag == 1 && (sen_l.diff < 5) && (sen_r.diff < 5) && (translation_ideal.velocity > 100.0f) ){
    ...
    // 2019 1/25 fl: , l: , fr: , r:
    if ( sen_fl.now > 140 && sen_fl.diff < 50 ){
      sidewall_control_value = (float)0.6f * ( sen_fl.now - 110 );
    } else if ( sen_l.now > 750 && sen_l.diff_1ms < 50 ){
      sidewall_control_value = (float)0.6f * ( sen_l.now - 710 );
    } else if ( sen_fr.now > 130 && sen_fr.diff < 50 ){
      sidewall_control_value = (float)-0.6f * ( sen_fr.now - 100 );
    } else if ( sen_r.now > 710 && sen_r.diff_1ms < 50 ){
